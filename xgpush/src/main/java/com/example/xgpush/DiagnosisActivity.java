...
import com.example.xgpush.cloud.ClickAction;
import com.example.xgpush.cloud.Style;
import com.example.xgpush.cloud.TimeInterval;
import com.example.xgpush.cloud.XingeApp;
import com.example.xgpush.common.CommonWorkingThread;
import com.example.xgpush.common.ExtendedListView;
...
import static com.example.xgpush.common.ExtendedListView.OnPositionChangedListener;
...
public class DiagnosisActivity extends Activity implements OnPositionChangedListener {
	...
	private void step7() {
		...
		int ret_code = 0;
		try {
			com.example.xgpush.cloud.Message message = new com.example.xgpush.cloud.Message();
			message.setType(com.example.xgpush.cloud.Message.TYPE_NOTIFICATION);
