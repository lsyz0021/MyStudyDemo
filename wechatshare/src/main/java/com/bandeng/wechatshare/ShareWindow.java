...
public class ShareWindow extends PopupWindow implements OnClickListener {
    ...
    private LinearLayout btnShareWeiXin, btnShareSMS, btnShareWeiXinQuan;
    ...
    public ShareWindow(Context context, Map<String, Object> shareMsm) {
        ...
        mMenuView = inflater.inflate(R.layout.layout_share_popupwindow, null);
        ...
        btnShareWeiXin = (LinearLayout) mMenuView.findViewById(R.id.shareweixin);
        btnShareWeiXinQuan = (LinearLayout) mMenuView.findViewById(R.id.sharefriendquan);
        btnShareSMS = (LinearLayout) mMenuView.findViewById(R.id.sharesms);
